...
categories: aws
cover_image: https://johanneskonings.dev/content/blog/2026-02-02-tanstack-ai-bedrock-simple/cover-image.png
tags:
  - aws
  - cdk
  - tanstack
...
The template repository includes a demo chat powered by AWS Bedrock (Claude) with streaming. For a screenshot and deployment overview, see the [TanStack Start serverless](https://johanneskonings.dev/blog/2025-11-30-tanstack-start-aws-serverless) post.

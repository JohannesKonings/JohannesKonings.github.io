...
categories: aws
cover_image: https://johanneskonings.dev/content/blog/2025-12-31-cdk-bootstrap-customized-template/cover-image.png
tags:
  - aws
  - cdk
  - cdk-nag
...
![staging-bucket-custom-kms-encrypted](https://johanneskonings.dev/content/blog/2025-12-31-cdk-bootstrap-customized-template/staging-bucket-custom-kms-encrypted.png)

**Server access logging configuration:**
![staging-bucket-server-access-logging](https://johanneskonings.dev/content/blog/2025-12-31-cdk-bootstrap-customized-template/staging-bucket-server-access-logging.png)

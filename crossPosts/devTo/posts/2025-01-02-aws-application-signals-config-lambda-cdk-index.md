...
categories: aws
cover_image: https://johanneskonings.dev/content/blog/2025-01-02-aws-application-signals-config-lambda-cdk/cover-image.png
tags:
  - aws
...
![application signals config steps](https://johanneskonings.dev/content/blog/2025-01-02-aws-application-signals-config-lambda-cdk/application-signals-config-steps.png)
...
![application signals result](https://johanneskonings.dev/content/blog/2025-01-02-aws-application-signals-config-lambda-cdk/result.png)

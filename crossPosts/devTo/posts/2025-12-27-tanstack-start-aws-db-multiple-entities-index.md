...
categories: aws
cover_image: https://johanneskonings.dev/content/blog/2025-12-27-tanstack-start-aws-db-multiple-entities/cover-image.png
tags:
  - aws
  - cdk
  - tanstack
...
In [Simple example of TanStack DB with DynamoDB on AWS](https://johanneskonings.dev/blog/2025-12-20-tanstack-start-aws-db-simple), I describe how to use TanStack DB with a single entity in combination with DynamoDB.
...
![TanStack DB Architecture](https://johanneskonings.dev/content/blog/2025-12-27-tanstack-start-aws-db-multiple-entities/tanstack-db-architecture.png)
...
![result ddb](https://johanneskonings.dev/content/blog/2025-12-27-tanstack-start-aws-db-multiple-entities/result-ddb.png)
...
![result page](https://johanneskonings.dev/content/blog/2025-12-27-tanstack-start-aws-db-multiple-entities/result-page.png)

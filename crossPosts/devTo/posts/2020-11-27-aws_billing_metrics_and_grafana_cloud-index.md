...
categories: aws
thumbnail: grafana
cover_image: https://johanneskonings.dev/content/blog/2020-11-27-aws_billing_metrics_and_grafana_cloud/grafana_cloud_created_dashboard.png
tags:
  - aws
  - grafana
published: true
...
![Grafana Cloud pricing](https://johanneskonings.dev/content/blog/2020-11-27-aws_billing_metrics_and_grafana_cloud/grafana_cloud_pricing.png)

After login, create a stack with the starter plan.

![Grafana Cloud add stack](https://johanneskonings.dev/content/blog/2020-11-27-aws_billing_metrics_and_grafana_cloud/grafana_cloud_add_stack.png)

![Grafana Cloud starter plan](https://johanneskonings.dev/content/blog/2020-11-27-aws_billing_metrics_and_grafana_cloud/grafana_cloud_starter_plan.png)

Then log in to your instance.

![Grafana Cloud instance login](https://johanneskonings.dev/content/blog/2020-11-27-aws_billing_metrics_and_grafana_cloud/grafana_cloud_instance_login.png)
...
![Grafana Cloud add datasource](https://johanneskonings.dev/content/blog/2020-11-27-aws_billing_metrics_and_grafana_cloud/grafana_cloud_add_datasource.png)

![Grafana Cloud select cloudwatch datasource](https://johanneskonings.dev/content/blog/2020-11-27-aws_billing_metrics_and_grafana_cloud/grafana_cloud_select_cloudwatch_datasource.png)

As for credentials, use the access key and secret key from the IAM user.

![Grafana Cloud configuration cloudwatch datasource](https://johanneskonings.dev/content/blog/2020-11-27-aws_billing_metrics_and_grafana_cloud/grafana_cloud_configuration_cloudwatch_datasource.png)

# Creation of a dashboard with a graph panel

Now you can use the data source in the panels of a dashboard.

![Grafana Cloud create dashboard](https://johanneskonings.dev/content/blog/2020-11-27-aws_billing_metrics_and_grafana_cloud/grafana_cloud_create_dashboard.png)

![Grafana Cloud add panel](https://johanneskonings.dev/content/blog/2020-11-27-aws_billing_metrics_and_grafana_cloud/grafana_cloud_add_panel.png)

This is a panel configuration example for the costs of all linked accounts.

![Grafana Cloud accounts panel](https://johanneskonings.dev/content/blog/2020-11-27-aws_billing_metrics_and_grafana_cloud/grafana_cloud_accounts_panel.png)
...
![Grafana Cloud created dashboard](https://johanneskonings.dev/content/blog/2020-11-27-aws_billing_metrics_and_grafana_cloud/grafana_cloud_created_dashboard.png)
...
![Grafana Cloud import dashboard](https://johanneskonings.dev/content/blog/2020-11-27-aws_billing_metrics_and_grafana_cloud/grafana_cloud_import_dashboard.png)

The selection of the data source is required.

![Grafana Cloud import dashboard2](https://johanneskonings.dev/content/blog/2020-11-27-aws_billing_metrics_and_grafana_cloud/grafana_cloud_import_dashboard2.png)

And ready to go 🎉

![Grafana Cloud imported dashboard](https://johanneskonings.dev/content/blog/2020-11-27-aws_billing_metrics_and_grafana_cloud/grafana_cloud_imported_dashboard.png)

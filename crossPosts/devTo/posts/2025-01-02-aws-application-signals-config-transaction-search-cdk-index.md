...
categories: aws
cover_image: https://johanneskonings.dev/content/blog/2025-01-02-aws-application-signals-config-transaction-search-cdk/cover-image.png
tags:
  - aws
...
![application signals transaction search without config](https://johanneskonings.dev/content/blog/2025-01-02-aws-application-signals-config-transaction-search-cdk/application-signals-transaction-search-without-config.png)

And this is how it appears in the X-Ray settings:

![application signals transaction search without config X-Ray](https://johanneskonings.dev/content/blog/2025-01-02-aws-application-signals-config-transaction-search-cdk/application-signals-transaction-search-without-xray-config.png)
...
![application signals transaction search enabled in X-Ray settings](https://johanneskonings.dev/content/blog/2025-01-02-aws-application-signals-config-transaction-search-cdk/result-transaction-search-xray-settings.png)

![application signals transaction search enabled in CloudWatch](https://johanneskonings.dev/content/blog/2025-01-02-aws-application-signals-config-transaction-search-cdk/result-transaction-search.png)

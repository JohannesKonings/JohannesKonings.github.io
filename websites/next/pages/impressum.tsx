						...
						<div className="error-text">
							<div className="impressum">
								...
								<p>
									...
									<br />
									E-Mail:{" "}
									<a href="mailto:mail@johanneskonings.dev">
										mail@johanneskonings.dev
									</a>
									<br />
								</p>
								<p>
									...
									Verwertung außerhalb des Grenzen des Urheberrechtes bedürfen
									...
									Analytics verwendet sog. &apos;&apos;Cookies&apos;&apos;,

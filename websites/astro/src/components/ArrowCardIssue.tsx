import { INFO_AWS_SLS_MANAGEMENT_GOVERNANCE } from "@consts";
import { formatDate } from "@lib/utils";
import type { CollectionEntry } from "astro:content";

type Props = {
	entry: CollectionEntry<"infoSlsManagementGovernance">;
	pill?: boolean;
};

export default function ArrowCardIssue({ entry, pill }: Props) {
	return (
		<a
			href={`/${INFO_AWS_SLS_MANAGEMENT_GOVERNANCE.PATH}/${entry.slug}`}

 ...
 * Run after sync so src/content/blog is populated. Writes to public/sitemap-index.xml.
...
const CONTENT_NOTES = path.join(ROOT, "src/content/notes");
const OUT_FILE = path.join(ROOT, "public/sitemap-index.xml");

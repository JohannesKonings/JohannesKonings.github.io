...
export default function Impressum() {
  return (
    <>
      <div key='impressum' className="container-fluid index error">
        <div className="row">

          <div className="col-md-12 content-panel articles">
            <h1 className="header author-header">Impressum</h1>

            <div className="error-text">
              <div className='impressum'>
                <p>Angaben gemäß § 5 TMG</p>
                <p>Johannes Konings <br />
                  Hohenzollernstr. 9<br />
                  79106 Freiburg <br />
                </p>
                ...
                <p><strong>Kontakt:</strong> <br />
                  Telefon: 0-0<br />
                  E-Mail: <a href='mailto:mail@johanneskonings.dev'>mail@johanneskonings.dev</a><br /></p>
                <p><strong>Haftungsausschluss: </strong><br /><br /><strong>Haftung für Links</strong><br /><br />
                  ...
                  in der zuvor beschriebenen Art und Weise und zu dem zuvor benannten Zweck einverstanden.</p><br />
